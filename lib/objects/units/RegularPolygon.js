...
export function RegularPolygon({ sides, center, radius, rotation, ref, color }) {
  const points = useMemo(() => generatePolygonPoints(sides, center, radius, rotation), [sides, center, radius, rotation])
  ...
  return (
    ...
    <line ref={ref} geometry={geometry}>
      <lineBasicMaterial attach="material" color={color || '#fff'} linewidth={1000} linecap="round" linejoin="round"></lineBasicMaterial>
    </line>
  )
}
